...
# base_dir = os.path.join(os.getcwd(), "/static/imgs/carpics")
base_dir = "./static/imgs/carpics"
...
def car_check(pic_file):
    roi, label, color = CaridDetect(os.path.join(base_dir, pic_file))
    if roi is None and label is None and color is None:
        return None
    save_path = base_dir + "/result" + pic_file.split(".")[0]
